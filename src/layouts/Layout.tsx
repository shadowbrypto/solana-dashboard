              ...
              return (
                ...
                >
                  ...
                  <span className="flex items-center gap-2">
                    ...
                    {page.new && (
                      <span className="text-[8px] px-1 py-0.5 rounded font-medium bg-emerald-500 text-white shadow-sm border border-emerald-600 dark:bg-emerald-600 dark:border-emerald-500">
                        NEW
                      </span>
                    )}
                  </span>
