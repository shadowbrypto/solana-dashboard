...
export function MonthlyChainVolumeChart({ endDate }: MonthlyChainVolumeChartProps) {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        console.log('MonthlyChainVolumeChart - Fetching data for month ending:', format(endDate, 'yyyy-MM-dd'));
        ...
        console.log('MonthlyChainVolumeChart - EVM response:', evmResponse);
        ...
        console.log('MonthlyChainVolumeChart - Transformed data:', transformedData);
    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-col lg:flex-row gap-4 lg:items-stretch">
        ...
        <div className="flex-1 flex flex-col">
          <StackedBarChart
            title="Monthly Chain Volume Distribution"
            subtitle={`${monthName} • ${dayCount}-day volume by chain`}
            data={chartData}
